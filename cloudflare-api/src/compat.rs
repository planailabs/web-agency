...
impl SimpleClient {
    ...
    pub async fn create_zone(&self, name: &str, account_id: &str) -> Result<Zone, Error> {
        self.post(
            "/zones",
            &serde_json::json!({"name": name, "account": {"id": account_id}}),
        )
        .await
    }
    ...
    pub async fn list_dns_records(&self, zone_id: &str) -> Result<Vec<DnsRecord>, Error> {
        self.get(&format!("/zones/{zone_id}/dns_records?per_page=500"))
            .await
    }
    ...
    pub async fn set_ssl_mode(
        &self,
        zone_id: &str,
        value: &str,
    ) -> Result<serde_json::Value, Error> {
        self.patch(
            &format!("/zones/{zone_id}/settings/ssl_automatic_mode"),
    ...
    pub async fn set_bot_management(
        &self,
        zone_id: &str,
        config: &serde_json::Value,
    ) -> Result<serde_json::Value, Error> {
        self.put(&format!("/zones/{zone_id}/bot_management"), config)
            .await
    }
    ...
    pub async fn get_domain_registration(
        ...
        account_id: &str,
        domain_name: &str,
    ) -> Result<DomainRegistration, Error> {
        self.get(&format!(
    ...
    pub async fn check_domains(
        ...
        account_id: &str,
        domains: &[String],
    ) -> Result<Vec<DomainCheck>, Error> {
        #[derive(serde::Deserialize)]
        struct Res {
            domains: Option<Vec<DomainCheck>>,
        }
        let r: Res = self
            .post(
    ...
    pub async fn list_pages_projects(&self, account_id: &str) -> Result<Vec<PagesProject>, Error> {
        self.get(&format!("/accounts/{account_id}/pages/projects"))
            .await
    }
    ...
    pub async fn create_pages_project(
        ...
        self.post(
            ...
            &serde_json::json!({"name": name, "production_branch": branch}),
        )
        .await
    }
    ...
    pub async fn update_pages_project(
        ...
        account_id: &str,
        project_name: &str,
        update: &UpdatePagesProject,
    ) -> Result<PagesProject, Error> {
        self.patch(
            &format!("/accounts/{account_id}/pages/projects/{project_name}"),
            update,
        )
        .await
    }

    pub async fn list_pages_custom_domains(
        &self,
        account_id: &str,
        project_name: &str,
    ) -> Result<Vec<PagesCustomDomain>, Error> {
        ...
        for item in &arr {
            match serde_json::from_value::<PagesCustomDomain>(item.clone()) {
                Ok(d) => domains.push(d),
                Err(e) => {
                    tracing::warn!(error = %e, raw = %item, "skipping unparseable Pages domain")
                }
            }
        }
    ...
    pub async fn get_pages_custom_domain(
        &self,
        account_id: &str,
        project_name: &str,
        domain: &str,
    ) -> Result<PagesCustomDomain, Error> {
        self.get(&format!(
    ...
    pub async fn add_pages_custom_domain(
        &self,
        account_id: &str,
        project_name: &str,
        domain: &str,
        ...
        self.post(
            &format!("/accounts/{account_id}/pages/projects/{project_name}/domains"),
            &serde_json::json!({"name": domain}),
        )
        .await
    }

    pub async fn remove_pages_custom_domain(
        &self,
        account_id: &str,
        project_name: &str,
        domain: &str,
    ...
    pub async fn retry_pages_custom_domain(
        &self,
        account_id: &str,
        project_name: &str,
        domain: &str,
        ...
        self.patch(
            &format!("/accounts/{account_id}/pages/projects/{project_name}/domains/{domain}"),
            &serde_json::json!({}),
        )
        .await
    }
